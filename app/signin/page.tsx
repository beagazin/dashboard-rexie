        ...
        <div className="w-full max-w-md">
          <div className="rounded-lg border border-gray-800 bg-gray-900 p-8">
            ...
            <a
              ...
              className="flex items-center justify-center gap-3 rounded-lg bg-[#5865F2] px-6 py-3 font-medium text-white transition-colors hover:bg-[#4752C4]"
            >
              <svg
                className="h-6 w-6"
                fill="currentColor"
            ...
            <div className="mt-6 text-center text-xs text-gray-500">
              ...
              <Link href="#" className="text-[#9c6dfc] hover:text-[#b896fc]">
                Termos de Uso
              </Link>{" "}
              e{" "}
              <Link href="#" className="text-[#9c6dfc] hover:text-[#b896fc]">
